    ...
    messages = [
        SystemMessage(
            content=(
                ...
                'needs_privacy = true → question involves data privacy, GDPR, CCPA, user consent, or data breaches'
            )
        ),
        HumanMessage(content=state["question"]),
    ]
...
async def main():
    ...
    print("\n[Hệ thống] Đã lưu sơ đồ đồ thị thành file graph.png tại thư mục gốc!")
